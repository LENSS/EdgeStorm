...
public class MyAgeAnalyzer extends Processor {
    private final String TAG="MyAgeAnalyzer";
    Logger logger;
    ...
    public void execute(){
        ...
        while (!Thread.currentThread().isInterrupted()) {
            ...
            if(pktRecv != null){
                ...
                logger.debug("===== AgeAnalyzer received a frame ====="+ taskID);

                // get recognition result and confidence
                final List<Recognition> results = classifier.recognizeImage(scaledBitmap);
