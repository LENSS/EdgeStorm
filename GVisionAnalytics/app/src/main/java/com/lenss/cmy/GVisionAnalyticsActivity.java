...
import com.lenss.cmy.gvisionanalytics.GVisionAnalyticsTopology;
...
public class GVisionAnalyticsActivity extends AppCompatActivity{ //ActionBarActivity
    public static final String TAG = "GVisionAnalyticsActivity";
    ...
    private static final String apkFileName = "GVisionAnalytics.apk";
    ...
    public static int ageAnalyzerParallel = 1;
    public static int genderAnalyzerParallel = 1;
    public static int emotionAnalyzerParallel = 1;
    ...
    public static int ageAnalyzerGroupingMethod = Topology.Shuffle;
    public static int genderAnalyzerGroupingMethod = Topology.Shuffle;
    public static int emotionAnalyzerGroupingMethod = Topology.Shuffle;
    ...
    public static int ageAnalyzerScheduleReq = Topology.Schedule_Any;
    public static int genderAnalyzerScheduleReq = Topology.Schedule_Any;
    public static int emotionAnalyzerScheduleReq = Topology.Schedule_Any;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                Intent intent = new Intent(GVisionAnalyticsActivity.this, DetailsActivity.class);
                ...
                public void onClick(DialogInterface dialog, int which) {
                    try {
                        ...
                        if(faceDetectorParallel<=0 || faceDetectorParallel>10){
                            ...
                            Toast.makeText(GVisionAnalyticsActivity.this, "Set an integer between 1 and 10!", Toast.LENGTH_SHORT).show();
                        }
                        ...
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            switch (selectedPosition) {
                                ...
                                case 1: // Local Video
                                    ...
                                    break;
                                case 2: // RTSP Camera
                                    AlertDialog.Builder alert = new AlertDialog.Builder(GVisionAnalyticsActivity.this);
                                    final EditText ssBox = new EditText(GVisionAnalyticsActivity.this);
                        ...
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            switch (selectedPosition) {
                                ...
                                case 4: // Manually Setting
                                    final EditText frBox = new EditText(GVisionAnalyticsActivity.this);
                                    frBox.setHint("Default (F/s): " + frameRate);
                                    layout.addView(frBox);
                                    new AlertDialog.Builder(GVisionAnalyticsActivity.this)
                                        .setView(layout)
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            try {
                                                ...
                                                if(fr >15 || fr <= 0){
                                                    frameRate = "1";
                                                    Toast.makeText(GVisionAnalyticsActivity.this, "Set an integer between 1 and 15!", Toast.LENGTH_SHORT).show();
                                                }
                                            } catch(NumberFormatException nfe){
                                                frameRate = "1";
                                                Toast.makeText(GVisionAnalyticsActivity.this, "Set an integer between 1 and 15!", Toast.LENGTH_SHORT).show();
    ...
    public void submitTopology(){
        if (topologyID != 0) {
            ...
            Topology topology = GVisionAnalyticsTopology.createTopology();
...
//        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case MSG_NUM_OF_FACES:
                    ...
                    break;
                case MSG_RTSP:
                    Toast.makeText(GVisionAnalyticsActivity.this, msg.obj.toString(), Toast.LENGTH_SHORT).show();
                    break;
    ...
    private class AsyncShowPicTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                ...
                Toast.makeText(GVisionAnalyticsActivity.this, "Failed to fetch data!", Toast.LENGTH_SHORT).show();
            }
    ...
    private class TrainFaces extends AsyncTask<Void, Void, Void> {
        ProgressDialog dialog = new ProgressDialog(GVisionAnalyticsActivity.this);

        @Override
        protected void onPreExecute() {
            logger.debug("initRecAsync onPreExecute called");
        ...
        protected Void doInBackground(Void... args) {
            ...
            if (success) {
                ...
                if (!new File(Constants.getFaceShapeModelPath()).exists()) {
                    Utils.copyFileFromRawToOthers(GVisionAnalyticsActivity.this, R.raw.shape_predictor_5_face_landmarks, Constants.getFaceShapeModelPath());
                }
                if (!new File(Constants.getFaceDescriptorModelPath()).exists()) {
                    Utils.copyFileFromRawToOthers(GVisionAnalyticsActivity.this, R.raw.dlib_face_recognition_resnet_model_v1, Constants.getFaceDescriptorModelPath());
                }
            } else {
                logger.debug("No Dlib directory and cannot create Dlib directory");
            }
