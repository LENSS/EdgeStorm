...
public class MyGenderAnalyzerFromFeature extends Processor {
    private final String TAG="MyGenderAnalyzerFromFeature";
    Logger logger;
    ...
    public void execute(){
        ...
        while (!Thread.currentThread().isInterrupted()) {
            ...
            if(pktRecv != null){
                ...
                logger.info("===== MyGenderAnalyzerFromFeature received feature maps ====="+ featureMapByteArray.length);
                ...
                logger.info("===== MyGenderAnalyzerFromFeature dequantized FeatureMaps ====="+ dequantizedFeatureMaps.remaining());
                long endDeQuantizationTime = SystemClock.elapsedRealtimeNanos();
                logger.info("MyGenderAnalyzerFromFeature DeQuantizationT:"+(endDeQuantizationTime-startDeQuantizationTime));
                ...
                logger.info("MyGenderAnalyzerFromFeature result=============="+log);
