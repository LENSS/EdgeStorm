...
public class MyEmotionAnalyzer extends Processor{
    private final String TAG="MyEmotionAnalyzer";
    Logger logger;
    ...
    public void execute(){
        ...
        while (!Thread.currentThread().isInterrupted()) {
            ...
            if(pktRecv != null){
                ...
                logger.debug("===== EmotionAnalyzer received a frame ====="+ taskID);
