...
public class DataMonitor implements Watcher,AsyncCallback.DataCallback, AsyncCallback.StatCallback,AsyncCallback.StringCallback,AsyncCallback.ChildrenCallback{
    ...
    public void register(String cluster_id)  {
        zk.create(CLUSTER_DIR + "/" + cluster_id + NODES_DIR +"/" + MStormWorker.GUID + ":" + MStormWorker.isPublicOrPrivate + ":" + MStormWorker.availability,
    ...
    public void unregister(String cluster_id){
        try {
            zk.delete(CLUSTER_DIR + "/" + cluster_id + NODES_DIR +"/" + MStormWorker.GUID + ":" + MStormWorker.isPublicOrPrivate + ":" + MStormWorker.availability,-1);
